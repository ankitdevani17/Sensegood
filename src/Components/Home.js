...
const Home = () => {
  return (
    ...
    <main id="main">
    <section id="color-bg" class="color-bg">
      <div class="color-content">
        <h5>CUSTOMER APPLICATIONS</h5>
        <h2>The world is color. We understand exactly why the color is important for you.</h2><br/>
        <p>Achieving right color requires first measuring it accurately. Ensure color quality and consistency of your product using Sensegood Spectrophotometer.</p>
        <br/><a href="color-measurement.php">Explore</a>
      </div>
    </section>

    <section id="color-bg" class="color-bg1">
      <div class="color-content">
        <h5>CUSTOMER APPLICATIONS</h5>
        <h2>Be it military or space, we understand the importance of reliability and robustness.</h2><br/>
        <p>Sensegood offers electronics sub-systems and solutions to space, defence, telecom and other related industries by engaging and enhancing disruptive technology.</p>
        <br/><a href="space-defence-electronics.php">Explore</a>
      </div>
    </section>
      ...
      <div class="container">
        ...
        <div class="row">
          <div class="col-lg-4 col-md-6 icon-box" >
            <div class="icon"><img src="https://sensegoodinstruments.com/assets/img/medal.png" class="whyus" width="25%"/></div><br/>
            <h4 class="title">Lorem</h4>
            <p class="description">Voluptatum deleniti atque corrupti quos dolores et quas molestias excepturi sint occaecati cupiditate non provident</p>
          </div>
          <div class="col-lg-4 col-md-6 icon-box">
            <div class="icon"><img src="https://sensegoodinstruments.com/assets/img/fast-delivery.png" class="whyus" width="25%"/></div><br/>
            <h4 class="title"><a href="">Ipsum</a></h4>
            <p class="description">Minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat tarad limino ata</p>
          </div>
          <div class="col-lg-4 col-md-6 icon-box">
            <div class="icon"><img src="https://sensegoodinstruments.com/assets/img/money.png" class="whyus" width="25%"/></div><br/>
